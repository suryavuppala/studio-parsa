...
export default function FeaturesSection({ isDarkMode }) {
  ...
  useEffect(() => {
    // Always visible fallback on small screens
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            From concept to completion, we offer comprehensive design services that transform your
            vision into extraordinary spaces.
          </p>
          <div
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              {/* Background Pattern */}
              <div
                className={`absolute top-0 right-0 w-20 h-20 opacity-5 transition-opacity duration-300 ${
        ...
        {/* CTA Section */}
        <div
          className={`mt-20 text-center transform transition-all duration-1000 delay-300 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'
          }`}
        >
          <div
          ...
          >
            <h3 className={`text-3xl md:text-4xl font-bold mb-6 ${isDarkMode ? 'text-[#F5F5F5]' : 'text-white'}`}>
              Ready to Start Your Project?
            </h3>
            <p className={`text-lg mb-8 ${isDarkMode ? 'text-[#F5F5F5]/80' : 'text-white/90'}`}>
            ...
            <button
              ...
              className={`px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-xl ${
                isDarkMode ? 'bg-[#D6B29D] text-[#0F0F0F] hover:bg-[#C5A08A]' : 'bg-white text-[#A87E6E] hover:bg-[#F5F5F5]'
              }`}
            >
